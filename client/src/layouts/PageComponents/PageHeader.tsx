    ...
    <header className='page-header bg-white py-2 md:py-4'>
      {currentPage !== 'indexPage' && (
        <div className='container flex flex-col md:flex-row justify-between'>
          <div className='page-header__content w-full md:w-1/2 mb-3 md:mb-0'>
          ...
          {children && (
            <>
              ...
              <div className='page-header__nav sm:w-[50%] md:w-[45%] pt-2 mb-2 md:mb-0'>
                <ul className='page-header__nav-list flex justify-between md:justify-start'>{children}</ul>
              </div>
            </>
          )}
        </div>
