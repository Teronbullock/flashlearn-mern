...
export const MobileMenuBtn = ({
  ...
  const btnClass = classNames(
    "btn-mobile-toggle absolute right-0 z-[500] inline-flex h-[44px] w-[44px] cursor-pointer items-center justify-center rounded-full border-0 bg-white outline-none md:hidden",
