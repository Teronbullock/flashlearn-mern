...
ALTER TABLE "fc_sets" ADD CONSTRAINT "fc_sets_user_id_fc_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."fc_users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fc_refresh_tokens" ADD CONSTRAINT "fc_refresh_tokens_user_id_fc_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."fc_users"("id") ON DELETE no action ON UPDATE no action;